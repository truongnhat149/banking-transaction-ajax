...
describe('ScrollSpy', () => {
  ...
  describe('constructor', () => {
    ...
    it('should add the active class to the correct element (list.html-group markup)', done => {
      fixtureEl.innerHTML = [
        '<nav class="navbar">',
        '  <div class="list.html-group">',
        '    <a class="list.html-group-item" id="a-1" href="#div-1">div 1</a>',
        '    <a class="list.html-group-item" id="a-2" href="#div-2">div 2</a>',
        '  </div>',
        '</nav>',
        '<div class="content" style="overflow: auto; height: 50px">',
        '  <div id="div-1" style="height: 100px; padding: 0; margin: 0">div 1</div>',
