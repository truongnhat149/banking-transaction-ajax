...
describe('Tab', () => {
  ...
  describe('show', () => {
    ...
    it('should activate element by tab id in ordered list.html', done => {
      fixtureEl.innerHTML = [
    ...
    it('should activate element by tab id in nav list.html', done => {
      fixtureEl.innerHTML = [
        '<nav class="nav">',
    ...
    it('should activate element by tab id in list.html group', done => {
      fixtureEl.innerHTML = [
        '<div class="list.html-group" role="tablist">',
        '  <button type="button" data-bs-target="#home" role="tab">Home</button>',
